...
import 'package:home_water_delivery_management_system/Screens/vendor_screens/vendor_bottle_update.dart';
             ...
             child: Column(
                ...
                Text(widget.name),
                  ...
                  ElevatedButton(onPressed: (){
                    Get.to(VendorBottleUpdate(id:widget.id,size:widget.size,name:widget.name));
                  }, child: Text("Update")),
                    ElevatedButton(onPressed: (){
